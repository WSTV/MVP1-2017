<?php
  ...
  define('MAILCHIMP_API_KEY', 'f835cdd55625ffa06fc8b965264b71a0-us6');
  
  // ENTER LIST ID THO WHICH VISITORS ARE SUBSCRIBING
  define('MAILCHIMP_LIST_NAME', 'Whitespace Television Network (WSTV) Media Newsletter');
  ...
  $zipCode = trim(ucfirst($_POST['newsletter-zip']));

  
  // SEND EMAILS TO MAILCHIMP   
  $retval = $api->listSubscribe($listId, $emailAddress, array('FNAME' => $name, 'ZIPCODE' => $zipCode), null, true, null, null, true);
